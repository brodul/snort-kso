...
\subsubsection{Nacini preprecevanja} % (fold)

\paragraph{Spreminjanje pravil v pozarnem zidu} % (fold)
...
\subsubsection{Nacini zaznav napadov} % (fold)
...
\subsubsection{Nacini preprecevanja napadov} % (fold)


\paragraph{Spreminjanje lokalnega pozarnega zidu} % (fold)
